...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  MyResponse get_response(UUID id, MyRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := myservice.NewMyServiceClientFactory(trans, protocolFactory)
	...
	case "get_response":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "GetResponse requires 2 args")
			flag.Usage()
		}
		...
		value1 := argvalue1
		fmt.Print(client.GetResponse(value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
